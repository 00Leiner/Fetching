...
export class Curriculum{
    ...
    async create(getProgram: string, getYear: string, getSemester: string, getCurriculum: any){
        const response = await createCurriculum(getProgram, getYear, getSemester, getCurriculum);
        return response
    }

    async update(getID: string, getProgram: string, getYear: string, getSemester: string, getCurriculum: any){
        const response = await updateCurriculum(getID, getProgram, getYear, getSemester, getCurriculum);
        return response
    }
